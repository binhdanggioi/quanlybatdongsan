...
//			sqlSearch.append(" WHERE name = "+fieldSearch.getName()+"");
//		}
//		if(fieldSearch.getPhonenumber() != null) {
//			sqlSearch.append(" WHERE phonenumber = "+fieldSearch.getPhonenumber()+"");
//		}
//		if(StringUtils.isNotBlank(fieldSearch.getEmail())) {
//			sqlSearch.append(" WHERE email = "+fieldSearch.getEmail()+"");
//		}
//		if(fieldSearch.getStaffId() != null) {
//			sqlSearch.append(" WHERE staffid = "+fieldSearch.getStaffId()+"");
//		}
